<template>
    <el-scrollbar wrapClass="scrollbar-wrapper">
        <!--
         ...
         -->
        <el-menu :collapse="collapse" background-color="#363C42" text-color="#fff" active-text-color="#ffd04b" router :default-active="activePath" unique-opened @select="menuSelect">
